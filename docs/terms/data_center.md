---
title: Data Center
description: "Facility that stores, maintains, and provides access to datasets, including data selection, replication, documentation, and tailored product generation."
tags:
- core
- to be discussed
- calval ingest
