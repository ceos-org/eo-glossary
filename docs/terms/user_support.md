---
title: User Support
description: "User support is a function inside the payload data ground segment to support external users to interact with the segment, to handle user registration, inquiries, complaints."
tags:
- core
- to be discussed
- calval ingest
