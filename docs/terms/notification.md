---
title: Notification
description: "Function that informs registered recipients—internal ground segment elements or external users—about events in payload data."
tags:
- core
- to be discussed
- calval ingest
