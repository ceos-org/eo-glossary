---
title: Circulation
description: "PDGS function implementing the distribution of products between facilities in the same or different geographic locations."
tags:
- core
- to be discussed
- calval ingest
