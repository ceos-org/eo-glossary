---
title: User Category
description: "Classification of users in order to provide PDGS services with different access rights and service levels."
tags:
- core
- to be discussed
- calval ingest
