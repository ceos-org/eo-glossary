---
title: Guide Service
description: "Part of a Catalogue Service that provides detailed information concerning specific data sets which enable the user to make a detailed analysis of whether a data set or a specific granule within the..."
tags:
- core
- to be discussed
- calval ingest
