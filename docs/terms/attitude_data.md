---
title: Attitude Data
description: "Data representing spacecraft orientation, pointing, calibration, alignment, Euler angles, quaternions, rates, biases, and associated accuracy parameters."
tags:
- core
- to be discussed
- calval ingest
