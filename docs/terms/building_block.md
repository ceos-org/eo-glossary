...
description: "Set of functions with a well-defined external interface allowing reuse for different missions."
tags:
- core
- to be discussed
- calval ingest
