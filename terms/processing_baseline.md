...
description: "A combination of processor versions, auxiliary data and other needed enablers that allows the generation of a coherent set of EO products."
tags:
- core
- to be discussed
- calval ingest
