...
description: "Set of collections sharing a specific characteristic, e."
tags:
- core
- to be discussed
- calval ingest
...
Set of collections sharing a specific characteristic, e. g. same terms of conditions for access authorization
